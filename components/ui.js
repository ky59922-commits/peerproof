...
export const Card = ({ children, sx = {} }) => <div style={{ background: W, borderRadius: 12, border: `1px solid ${BR}`, padding: 24, ...sx }}>{children}</div>;
...
export const PW = ({ children }) => <div style={{ minHeight: "100vh", background: BG, fontFamily: ff }}>{children}</div>;
